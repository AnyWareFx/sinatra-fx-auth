...
Gem::Specification.new do |gem|
  ...
  gem.description = %q{Sinatra extension for RESTful Authentication with Role-based Authorization}
  gem.summary     = %q{Sinatra extension for RESTful Authentication with Role-based Authorization}
